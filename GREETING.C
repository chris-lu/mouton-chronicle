...
unsigned char far Page[4000];
unsigned short Cur_Char=0,Cur_Pos=0;
unsigned char Pal[192],Last[192];
void far interrupt (*Vide)(void);
unsigned char Txt[]={"**********************Mutant\r\r\r\r\routon Chronicles Version 0.10 \r\r\r11 Beta**********************\n\n -Genre : Simulation de combats de moutons\n -Createurs :\n    Dri C.      (GnoMaster)  :  Code /Gfx\n    Jolivalt J.       (dJo)  :  Gfx / Sfx\n    Baudin A.      (Bart57)  :  Gfx/Misc.\n -Date de creation : Dimanche 9 Janvier 1999\r\r\r\r2000 20:54:42      \r\r\r\r\r\r\r\r43      \r\r\r\r\r\r\r\r44\n\n......................................\n\n  Pour plus d'informations, vous pouvez consultez la page web officielle du jeu:    mchronicles.ifrance.com ou www.ifrance.com/mchronicles\n\n.         \n.         \n.         \n.\n Tous nos remerciements a ceux (ou celles) qui nous on aide dans l'aboutissement de ce projet....."};
...
{if(Txt[Cur_Char]=='\n')
	...
	{Cur_Pos--;Put_Char(' ',0,15,Page);Cur_Pos--;for(cont=0;cont<32000;cont++);}
else Put_Char(Txt[Cur_Char],0,15,Page);
Cur_Char++;Cur_Pos++;
delay(70);
Draw8025(Page);
}
for(cont=0;cont<12000;cont++) Draw8025(Page);
setvect(0x1c,Vide);
